<?php 
  ...
  $queryFirstYear = "SELECT * FROM add_subject WHERE course = 'BS Tourism Management' AND year = '1st'";
  $sqlFirstYear = mysqli_query($con, $queryFirstYear);

  $querySecondYear = "SELECT * FROM add_subject WHERE course = 'BS Tourism Management' AND year = '2nd'";
  $sqlSecondYear = mysqli_query($con, $querySecondYear);

  $queryThirdYear = "SELECT * FROM add_subject WHERE course = 'BS Tourism Management' AND year = '3rd'";
  $sqlThirdYear = mysqli_query($con, $queryThirdYear);

  $queryFourthYear = "SELECT * FROM add_subject WHERE course = 'BS Tourism Management' AND year = '4th'";
