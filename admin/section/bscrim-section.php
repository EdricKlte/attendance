<?php
  ...
  $queryFirstYear = "SELECT * FROM add_section WHERE course = 'BS Criminology' AND year_level = '1st' ";
  $sqlFirstYear = mysqli_query($con, $queryFirstYear);

  $querySecondYear = "SELECT * FROM add_section WHERE course = 'BS Criminology' AND year_level = '2nd' ";
  $sqlSecondYear = mysqli_query($con, $querySecondYear);

  $queryThirdYear = "SELECT * FROM add_section WHERE course = 'BS Criminology' AND year_level = '3rd' ";
  $sqlThirdYear = mysqli_query($con, $queryThirdYear);

  $queryFourthYear = "SELECT * FROM add_section WHERE course = 'BS Criminology' AND year_level = '4th' ";
